...
export default function DocumentsPage() {
  ...
  return (
    <>
      <PageHeader title="Document Upload" subtitle="Upload TXT or Markdown files for local chunking, mock embeddings, retrieval logs, and chat citations. PDF is accepted as a documented stub." />
      <Panel>
      ...
      <Panel className="mt-4">
        ...
        <div className="mt-3 space-y-2">
          {documents.length === 0 && <EmptyState text="No documents indexed yet. Upload a sample file from examples/sample_docs." />}
          {documents.map((doc) => (
